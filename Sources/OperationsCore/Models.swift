...
public struct PermanentRemovalImpact:Codable,Equatable,Sendable,Identifiable{public var id:String{canonicalInstrument};public let canonicalInstrument:String;public let retirementID:String;public let retiredAt:String;public let reason:String;public let selectedLanes:[String];public let canonicalBars:Int;public let provenanceRecords:Int;public let rawEvidenceBlocks:Int;public let removable:Bool;public let blockingReason:String?;public let requiredConfirmation:String;enum CodingKeys:String,CodingKey{case reason,removable;case canonicalInstrument="canonical_instrument",retirementID="retirement_id",retiredAt="retired_at",selectedLanes="selected_lanes",canonicalBars="canonical_bars",provenanceRecords="provenance_records",rawEvidenceBlocks="raw_evidence_blocks",blockingReason="blocking_reason",requiredConfirmation="required_confirmation"}}
