...
public struct ProviderInventoryItem:Codable,Equatable,Sendable,Identifiable { public var id:String{provider};public let provider:String;public let enabled:Bool;public let credentialRequirement:String;public let credentialState:String;public let entitlement:String;public let requestLimit:Int;public let operationalLimit:Int;public let requestWindowSeconds:Int;public let concurrencyLimit:Int;public let approvedMappings:Int;public let supportedAssetClasses:[String];public let supportedTimeframes:[String];public let ratePolicyVerified:Bool;enum CodingKeys:String,CodingKey{case provider,enabled,entitlement;case credentialRequirement="credential_requirement",credentialState="credential_state",requestLimit="request_limit",operationalLimit="operational_limit",requestWindowSeconds="request_window_seconds",concurrencyLimit="concurrency_limit",approvedMappings="approved_mappings",supportedAssetClasses="supported_asset_classes",supportedTimeframes="supported_timeframes",ratePolicyVerified="rate_policy_verified"} }
