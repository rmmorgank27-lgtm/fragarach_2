...
public struct ProviderFactsSnapshot:Codable,Equatable,Sendable { public let contract:String;public let resolverVersion:Int;public let revision:Int?;public let capabilityProjectionRevision:Int?;public let generatedAt:String;public let credentialState:String;public let providerInventory:[ProviderInventoryItem]?;public let resolvedAutomatically:[ProviderFactMapping];public let needsMaterialReview:[ProviderFactMapping];public let credentialOrAccessIssue:ProviderFactIssue?;public let providerLookupFailed:[ProviderFactIssue];public let retiredNonActionable:[ProviderFactIssue];public let reconciliation:ProviderFactsReconciliation?;enum CodingKeys:String,CodingKey{case contract,reconciliation,revision;case resolverVersion="resolver_version",capabilityProjectionRevision="capability_projection_revision",generatedAt="generated_at",credentialState="credential_state",providerInventory="provider_inventory",resolvedAutomatically="resolved_automatically",needsMaterialReview="needs_material_review",credentialOrAccessIssue="credential_or_access_issue",providerLookupFailed="provider_lookup_failed",retiredNonActionable="retired_non_actionable"} }
