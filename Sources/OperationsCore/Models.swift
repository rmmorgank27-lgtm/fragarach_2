...
public struct ProviderInventoryItem:Codable,Equatable,Sendable,Identifiable { public var id:String{provider};public let provider:String;public let enabled:Bool;public let credentialRequirement:String;public let credentialState:String;public let entitlement:String;public let requestLimit:Int;public let operationalLimit:Int;public let requestWindowSeconds:Int;public let concurrencyLimit:Int;public let maximumConcurrencyLimit:Int;public let approvedMappings:Int;public let supportedAssetClasses:[String];public let supportedTimeframes:[String];public let ratePolicyVerified:Bool;enum CodingKeys:String,CodingKey{case provider,enabled,entitlement;case credentialRequirement="credential_requirement",credentialState="credential_state",requestLimit="request_limit",operationalLimit="operational_limit",requestWindowSeconds="request_window_seconds",concurrencyLimit="concurrency_limit",maximumConcurrencyLimit="maximum_concurrency_limit",approvedMappings="approved_mappings",supportedAssetClasses="supported_asset_classes",supportedTimeframes="supported_timeframes",ratePolicyVerified="rate_policy_verified"} }
public struct ProviderApprovedRoute:Codable,Equatable,Sendable,Identifiable { public var id:String{"\(asset):\(provider):\(providerSymbol)"};public let asset:String;public let provider:String;public let providerSymbol:String;public let timeframes:[String];public let mappingClass:String;public let authoritySource:String;public let calendarID:String?;public let enabled:Bool;enum CodingKeys:String,CodingKey{case asset,provider,timeframes,enabled;case providerSymbol="provider_symbol",mappingClass="mapping_class",authoritySource="authority_source",calendarID="calendar_id"} }
public struct ProviderFactsSnapshot:Codable,Equatable,Sendable { public let contract:String;public let resolverVersion:Int;public let revision:Int?;public let capabilityProjectionRevision:Int?;public let generatedAt:String;public let credentialState:String;public let providerInventory:[ProviderInventoryItem]?;public let approvedRoutes:[ProviderApprovedRoute]?;public let resolvedAutomatically:[ProviderFactMapping];public let needsMaterialReview:[ProviderFactMapping];public let credentialOrAccessIssue:ProviderFactIssue?;public let providerLookupFailed:[ProviderFactIssue];public let retiredNonActionable:[ProviderFactIssue];public let reconciliation:ProviderFactsReconciliation?;enum CodingKeys:String,CodingKey{case contract,reconciliation,revision;case resolverVersion="resolver_version",capabilityProjectionRevision="capability_projection_revision",generatedAt="generated_at",credentialState="credential_state",providerInventory="provider_inventory",approvedRoutes="approved_routes",resolvedAutomatically="resolved_automatically",needsMaterialReview="needs_material_review",credentialOrAccessIssue="credential_or_access_issue",providerLookupFailed="provider_lookup_failed",retiredNonActionable="retired_non_actionable"} }
...
public enum OperationIntent: Equatable, Sendable {
    ...
    case configureProvider(provider:String,enabled:Bool,operationalLimit:Int,concurrencyLimit:Int)
    case configureProviderRoute(provider:String,asset:String,providerSymbol:String,timeframe:String,mappingClass:String,calendarID:String)
