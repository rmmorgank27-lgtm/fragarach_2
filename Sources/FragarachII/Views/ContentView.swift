...
struct ContentView: View {
    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group { switch store.section { case .truth: TruthConsoleView(); case .lanes: LanesView(); case .authority: AuthorityLedgerView(); case .dataOperations: DataOperationsView(); case .addInstrument: DiscoverMarketView(); case .operations: OperationsView(); case .integrity: IntegrityBackupView(); case .settings: DiagnosticsSettingsView() } }
