...
struct ContentView: View {
    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group { switch store.section { case .lanes: LanesView(); case .acquire: AcquireView(); case .importEvidence: ImportView(); case .operations: OperationsView(); case .integrity: IntegrityBackupView(); case .settings: DiagnosticsSettingsView() } }
