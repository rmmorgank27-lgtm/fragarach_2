...
struct ContentView: View {
    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group { switch store.section { case .truth: TruthConsoleView(); case .marketHistory: MarketHistoryView(); case .discoverMarket: DiscoverMarketView(); case .dataOperations: DataOperationsView(); case .system: SystemWorkspaceView() } }
