...
struct TruthDetailView:View {
    ...
    var body:some View {
        VStack(alignment:.leading,spacing:16) {
            ...
            GroupBox("Provider Summary") { Facts([("Provider",lane.providerSummary.provider),("Confidence",lane.providerSummary.providerConfidence),("Freshness",lane.providerSummary.providerFreshness),("Entitlement",lane.providerSummary.entitlement)]) }
